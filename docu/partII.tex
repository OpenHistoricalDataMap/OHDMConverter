...
\section{osm2inter}
Für den Import von \gls{osm} Dateien soll ein bestehendes Tool \gequote{osm2pgsql}\cite{osm2pgsql} verwendet werden. osm2pgsql\cite{osm2pgsql} ist dafür ausgelegt \gls{osm} Daten in eine PostGIS Datenbank zu importieren.
...
\section{inter2ohdm}
Die Konvertierung der Intermediate Datenbank soll mithilfe von SQL Scripts realisiert werden. Hierbei soll, wenn möglich das Tool \gequote{psql}\cite{postgres-psql} eingesetzt werden.
...
\begin{lstlisting}[language={}]
	...
	-S /osm2inter/osm2inter.lua \
	-c /osm2inter/berlin.osm
\end{lstlisting}
