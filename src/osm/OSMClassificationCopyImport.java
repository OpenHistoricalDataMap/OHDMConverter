...
/**
 * Klasse OSMClassificationCopyImport<br>
 * beinhaltet alle Klassifizierungen der XML-Elemente von OSM<br>
 * stellt einige Hilfsmethoden zum Zugriff bereit<br>
 * ist komplett static<br>
 */
public class OSMClassificationCopyImport {
	private static final HashMap<String, List<String>> osmClasses = new HashMap<>();
	private static final HashMap<String, Integer> classCodes = new HashMap<>();

	static {
		fillOsmClasses();
		int id = 1;
		Iterator<String> mainClassIter = osmClasses.keySet().iterator();
		while (mainClassIter.hasNext()) {
			String tmpMainClass = mainClassIter.next();
			List<String> subClass = osmClasses.get(tmpMainClass);
			Iterator<String> subClassIter = subClass.iterator();
			while (subClassIter.hasNext()) {
				classCodes.put(tmpMainClass + "_" + subClassIter.next(), id++);
			}
		}
	}

	/**
	 * Methode fillOsmClasses()<br>
	 * füllt die Hashmap 'osmClasses' mit allen vorhandenen OSM-Klassifizierungen<br>
	 * subClasses einer mainClass kommen in temporäre Stringlist<br>
	 * diese Liste wird mit mainClass gemapped in 'osmClasses' hinterlegt<br>
	 */
	private static void fillOsmClasses() {
		List<String> subClasses = new ArrayList<>();
		subClasses.add("cable_car");
		subClasses.add("gondola");
		subClasses.add("chair_lift");
		subClasses.add("mixed_lift");
		subClasses.add("drag_lift");
		subClasses.add("t-bar");
		subClasses.add("j-bar");
		subClasses.add("platter");
		subClasses.add("rope_tow");
		subClasses.add("magic_carpet");
		subClasses.add("zip_line");
		subClasses.add("pylon");
		subClasses.add("station");
		subClasses.add("canopy");
		subClasses.add("goods");
		osmClasses.put("aerialway", subClasses);
		...
		osmClasses.put("aeroway", subClasses);
		...
		osmClasses.put("amenity", subClasses);
		...
		subClasses.add("wall");
		osmClasses.put("barrier", subClasses);
		...
		osmClasses.put("boundary", subClasses);
		...
		osmClasses.put("building", subClasses);
		...
		osmClasses.put("craft", subClasses);
		...
		osmClasses.put("emergency", subClasses);
		...
		osmClasses.put("geological", subClasses);
		...
		osmClasses.put("highway", subClasses);
		...
		osmClasses.put("historic", subClasses);
		...
		osmClasses.put("landuse", subClasses);
		...
		osmClasses.put("leisure", subClasses);
		...
		osmClasses.put("man_made", subClasses);
		...
		subClasses.add("airfield");
		osmClasses.put("military", subClasses);
		...
		osmClasses.put("natural", subClasses);
		...
		osmClasses.put("office", subClasses);
		...
		osmClasses.put("places", subClasses);
		...
		osmClasses.put("power", subClasses);
		...
		osmClasses.put("public_transport", subClasses);
		...
		osmClasses.put("railway", subClasses);
		...
		subClasses.add("tram");
		osmClasses.put("route", subClasses);
		...
		osmClasses.put("shop", subClasses);
		...
		subClasses.add("yoga");
		osmClasses.put("sport", subClasses);
		...
		subClasses.add("alpine_hut");
		subClasses.add("alpine_hut");
		osmClasses.put("tourism", subClasses);
		...
		subClasses.add("water_point");
		subClasses.add("fuel");
		osmClasses.put("waterway", subClasses);
		...
		osmClasses.put("ohdm_boundary", subClasses);

		subClasses = null;
	}

	/**
	 * Methode getOHDMClassCode()<br>
	 * gibt den Classcode der Kombinierung beider Parameter zurück<br>
	 * @param className ist der Name der Hauptklasse von OSM
	 * @param subClassName ist der Name der Subklasse von OSM
	 * @return den eigenen OHDMClassCode oder 0 falls nicht vorhanden
	 */
	public static int getOHDMClassCode(String className, String subClassName) {
		int iReturn = 0;
		if ((classCodes.get(className + "_" + subClassName)) != null) {
			iReturn = classCodes.get(className + "_" + subClassName);
		} else if ((classCodes.get(className + "_undefined")) != null) {
			iReturn = classCodes.get(className + "_undefined");
		}
		return iReturn;
	}

	/**
	 * Methode containsValue()<br>
	 * überprüft ob eine bestimmte Hauptklasse von OSM vorhanden ist<br>
	 * @param value beinhaltet die zu suchenden OSM Hauptklasse
	 * @return true wenn Klasse aus 'value' vorhanden ist, ansonsten false
	 */
	public static boolean containsValue(String value) {
		return (osmClasses.keySet().contains(value));
	}
}
