...
target_schema_to_be_replaced.my_amenities(geometry, object_id, geom_id, classid, type, name, valid_since, valid_until, tags, user_id, religion, denomination, power_source, score, access)
...
FROM
 ...
 (SELECT id_target, classification_id, type_target, id_geoobject_source, valid_since, valid_until, tags, source_user_id as user_id, 
  ...
  tags -> 'score' as score,
  tags -> 'access' as access FROM source_schema_to_be_replaced.geoobject_geometry) as gg,
