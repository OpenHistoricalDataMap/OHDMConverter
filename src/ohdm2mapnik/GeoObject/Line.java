...
public class Line extends GeoObject {
    ...
    public Line(long wayId, long geoobjectId, String name, String classificationClass, String classificationSubclassname, String tags, Date validSince, Date validUntil, String way) {
